...
public:
  udpServer(uint16_t broadcastPort)
    : work_(io_context_), socket_(io_context_, ip::udp::endpoint(ip::udp::v4(), 0)),
      remote_endpoint_(ip::address_v4::broadcast(), broadcastPort), deadline_(io_context_), tx_count_(0) {
